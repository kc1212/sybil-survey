...
by the hash of their RSA public key, then it is difficult to create identities
deterministically. Then nodes can be matched by the closeness of their
identities when they are in a DHT. The downside of this approach is that it
sacrifices a lot of privacy, every action that a node makes is monitored by some
other node.
