...
attempt to include all the seminal work in this area.
...
\begin{tabular}{||l||l||c|c|c||c|c|c|c|c|c|c|c|c|c||}
  ...
  2016 & SmartWalk~\cite{liu2016smartwalk}                    &           & $\bullet$ &           &           &           &           &           &           & $\bullet$ &           &           & $\bullet$ &           \\ \hline
  2016 & SybilExposer~\cite{misra2016sybilexposer}            &           & $\bullet$ &           &           &           &           &           &           &           & $\bullet$ &           &           &           \\ \bottomrule
\end{tabular}
\end{table*}
