...
begins to have certain properties, i.e. it will have a quotient cut.
Effectively, removing the attack edges will disconnect a large number of nodes
from the social graph. Many sybil defence mechanisms rely on the fact that
attack edges are difficult to create as we will describe in
