...
% In contrast to the existing surveys, we
% also try to cover the possible attacks that can be mounted using sybils as well
% as a wider range of defence mechanisms.
